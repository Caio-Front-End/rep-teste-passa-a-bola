...
const Chatbot = () => {
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      console.error('Erro ao contatar /api/chat:', error);
      const errorMessage = {
        from: 'bot',
        text: 'Desculpe, não consegui responder agora. Tente novamente mais tarde.',
      };
      ...
      >
        ...
        <div className="flex-1 p-4 overflow-y-auto bg-gray-50 dark:bg-gray-900">
          {messages.map((msg, idx) => (
            ...
            >
              <span
                className={`inline-block p-2 px-3 rounded-lg max-w-xs break-words shadow ${
                  msg.from === 'bot'
        ...
        >
          <div className="flex">
            ...
            <button
              type="submit"
              className="bg-[#b554b5] text-white p-3 rounded-r-md hover:bg-[#d44b84] transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
              disabled={isLoading}
